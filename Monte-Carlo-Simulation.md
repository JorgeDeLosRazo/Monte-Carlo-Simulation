...
Components in a crcuit typically have a tolerance associated with them, and these varying values due to tolerances can cause unexpected results or failure (in the case were precision is needed). The Monte Carlo analysis provides a range of possible results based on varying parameters measured. 
...
## Simulation of Current Through Network I
...
Running the following code we get some of the key statistical values of I are the following
```
>> mean ( I )
>> std ( I )
>> min ( I )
...
| Mean ($\mu$) | Std. Deviation ($\sigma$) | Minimum       | Maximum     |
|--------------|---------------------------|---------------|-------------|
| 0.3378A      | 0.0197                    | 0.2405A       |0.4434A      |
